...
//View Sizes
  ...
  app.post('/submitbill', checkAuthenticated,(req, res) => {
    ...
    var transaction_id = "RKB"+ date_format.getDate() + date_format.getMonth() + date_format.getFullYear() + date_format.getHours() + date_format.getMinutes() + date_format.getSeconds()
    let new_req = {};
